...
def generate_total(bank_path="accounting-suite/data/actuals.csv",
                    output_path ="accounting-suite/data/total_amount/total_actuals.csv"
):
    ...
    grouped = (
        bank_df
        .groupby(['cost_center', 'account', 'period'])['amount']
        .sum()
        .reset_index()
