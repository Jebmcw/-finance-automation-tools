...
def generate_total(bank_path="accounting-suite/data/ap_entries.csv",
                    output_path ="accounting-suite/data/total_amount/total_ap_entries.csv"
):
    ...
    grouped = (
        bank_df
        .groupby(['vendor_id', 'account', 'company_code', 'period'])['amount']
        .sum()
        .reset_index()
