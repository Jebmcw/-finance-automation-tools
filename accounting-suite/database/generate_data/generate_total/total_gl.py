...
def generate_total(bank_path="accounting-suite/data/gl_entries.csv",
                    output_path ="accounting-suite/data/total_amount/total_gl_entries.csv"
):
    ...
    grouped = (
        bank_df
        .groupby([ 'account', 'company_code', 'period'])['amount']
        .sum()
        .reset_index()
